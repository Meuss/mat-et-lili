<div>
    @if (session()->has('message'))
        <div class="bg-slate-700 p-4 text-white mb-0">
            {{ session('message') }}
        </div>
    @else
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                    <div class="col-span-full border-b border-gray-900/10 pb-6">
                        <div class="mt-5 space-y-5">
                            ...
                            <button type="button" wire:click="addGuest" class="text-sm bg-slate-700 px-4 py-2 text-white hover:bg-slate-600 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
